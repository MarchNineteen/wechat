...
public class HttpClientUtil {
    ...
    public static JSONObject doGetJson(String url, Map<String, String> param) {
        return JSONObject.parseObject(doGet(url, param));
    }
    ...
    public static JSONObject doPostReturnJson(String url, Map<String, String> param) {
        return JSONObject.parseObject(doPost(url, param));
    }

    public static JSONObject doPostReturnJson(String url) {
        return doPostReturnJson(url, null);
    }
